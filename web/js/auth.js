...
function ensureServerMode() {
    if (window.location.protocol === 'file:') {
        document.body.innerHTML = `
            <div style="padding:40px; max-width:760px; margin:80px auto; font-family:Arial, sans-serif; line-height:1.6; color:#222;">
                <h1 style="font-size:28px; margin-bottom:16px;">Error: la aplicación debe abrirse desde el servidor</h1>
                <p>Este proyecto no funciona si abre los archivos HTML directamente desde el explorador de archivos.</p>
                <p>Inicia el servidor con <code style="background:#f1f1f1; padding:4px 8px; border-radius:4px;">python run.py</code> y luego abre <code style="background:#f1f1f1; padding:4px 8px; border-radius:4px;">http://localhost:5000/admin.html</code> o <code style="background:#f1f1f1; padding:4px 8px; border-radius:4px;">http://localhost:5000/dashboard-maestria.html</code>.</p>
                <p style="margin-top:24px; color:#555;">Si ya tienes el servidor en ejecución, asegúrate de usar ese enlace en vez de abrir los archivos directamente.</p>
            </div>
        `;
        return false;
    }
